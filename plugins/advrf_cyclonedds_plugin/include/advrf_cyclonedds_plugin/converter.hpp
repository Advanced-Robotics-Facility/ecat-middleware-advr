...
namespace convert::protobuf {
    ...
    inline iit::advrf::Header convert_dds_to_protobuf(const std_msgs::msg::dds_::Header_& msgdds)
    {
    ...
    inline iit::advrf::Gains convert_dds_to_protobuf(const advrf_interfaces::msg::dds_::Gains_& msgdds)
    {
        iit::advrf::Gains pb;
    ...
    inline iit::advrf::Trajectory_cmd convert_dds_to_protobuf(const advrf_interfaces::msg::dds_::TrajectoryCmd_& msgdds)
    {
    ...
    inline iit::advrf::Ctrl_cmd convert_dds_to_protobuf(const advrf_interfaces::msg::dds_::CtrlCmd_& msgdds)
    {
    ...
    inline iit::advrf::Flash_cmd convert_dds_to_protobuf(const advrf_interfaces::msg::dds_::FlashCmd_& msgdds)
    {
    ...
    inline iit::advrf::Ecat_Master_cmd convert_dds_to_protobuf(const advrf_interfaces::msg::dds_::EcatMasterCmd_& msgdds)
    {
    ...
    inline iit::advrf::FOE_Master convert_dds_to_protobuf(const advrf_interfaces::msg::dds_::FoeMaster_& msgdds)
    {
    ...
    inline iit::advrf::Slave_SDO_cmd convert_dds_to_protobuf(const advrf_interfaces::msg::dds_::SlaveSdoCmd_& msgdds)
    {
    ...
    inline iit::advrf::Slave_SDO_info convert_dds_to_protobuf(const advrf_interfaces::msg::dds_::SlaveSdoInfo_& msgdds)
    {
    ...
    inline iit::advrf::Slave_registry_write convert_dds_to_protobuf(const advrf_interfaces::msg::dds_::SlaveRegistryWrite_& msgdds)
    {
    ...
    inline iit::advrf::PDOs_aux_cmd convert_dds_to_protobuf(const advrf_interfaces::msg::dds_::PdoAuxCmd_& msgdds)
    {
    ...
    inline iit::advrf::Repl_cmd convert_dds_to_protobuf(const advrf_interfaces::srv::dds_::ReplCmd_Request_& request)
    {
